...
const ArticleCard = ({ article }: { article: Article }) => {
  return (
    ...
    >
      ...
      >
        <img 
          src={article.illustration || "https://www.ispo.com/sites/default/files/styles/listicle_header_square_desktop/public/2022-11/man-playing-padel.jpeg?h=6f3285a6&itok=ZjsTkf_r"} 
          alt="profile-picture"
